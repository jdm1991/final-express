    ...
    <section className="bg-white py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          {/* Portfolio Tile 1 */}
          <div className="bg-white rounded-lg shadow-md h-auto sm:h-[350px] hover:scale-105 transition-all duration-300">
            <img
              src="/portfolio1.jpg"
              alt="Portfolio 1"
            ...
            <div className="p-4 sm:p-6">
              <h3 className="text-lg sm:text-xl font-bold mb-2">Website 1</h3>
          ...
          <div className="bg-white rounded-lg shadow-md h-auto sm:h-[350px] hover:scale-105 transition-all duration-300">
            ...
            />
            <div className="p-4 sm:p-6">
              <h3 className="text-lg sm:text-xl font-bold mb-2">Website 2</h3>
              <p className="text-gray-600 mb-4">
                A brief description of the website goes here.
              </p>
