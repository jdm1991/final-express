export default function BuildaWebsite() {
  return (
    <section className="bg-[#255036] py-12">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white p-8 rounded-lg shadow-lg">
          <div className="text-center">
            <h2 className="text-4xl font-semibold mb-6 text-[#255036]">
              Elevate Your Online Presence with a Freelance Website Designer
            </h2>
            <p className="text-2xl font-light text-gray-700">
              Looking to create a stunning website that drives results for your
