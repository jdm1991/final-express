...
export const metadata = {
  title: "Web Hosting & Maintenance Services | Express Web Design",
  description:
    "Reliable web hosting and maintenance services to keep your website secure, optimized, and up-to-date. Tailored solutions for businesses of all sizes.",
};
  ...
  return (
    <FadeInSection>
      <div className="bg-white">
        <section
          className="bg-gray-100 pt-20 pb-8 sm:pt-24 sm:pb-12 md:pb-16 bg-cover bg-center relative"
          style={{ backgroundImage: "url('/websiteHostingpic.jpeg')" }}
        >
          <div className="absolute inset-0 bg-black opacity-50"></div>
          <div className="max-w-7xl mx-auto px-2 sm:px-4 md:px-6 lg:px-8 relative z-10 pt-4 sm:pt-8 md:pt-12">
            <h1 className="text-xl xs:text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-4 text-white leading-tight tracking-tight">
            ...
            <p className="text-sm xs:text-base sm:text-lg mb-6 text-white">
              ...
              is to ensure that your website not only performs as it should but
              is also properly maintained. With our range of hosting options, we
            ...
            <div className="bg-[#255036] p-0.5 rounded-lg shadow-lg hover:scale-105 transition duration-300 ease-in-out group">
              <div className="bg-amber-500 text-white p-6 rounded-lg h-auto sm:h-40 relative overflow-hidden">
                ...
                <p className="text-sm relative">
                  ...
                  and threats. Our team will regularly monitor and apply
                  necessary security patches to maintain the integrity of your
                  website.
                </p>
              </div>
            </div>
