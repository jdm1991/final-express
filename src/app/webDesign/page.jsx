        ...
        >
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 pt-4 sm:pt-8 md:pt-12">
            ...
            <p className="text-lg mb-6 text-white">
              ...
              works closely with you to understand your unique goals and craft a
              custom website that looks great, delivers exceptional user
                  ...
                  <div className="md:flex-1">
                    <div className="p-6 sm:p-8 sm:pt-6 text-white">
                      ...
                      <p className="text-base mb-2">
                        ...
                        A combination of HTML, CSS & JavaScript. Alternatively,
                        we can also construct this with WordPress.
                      </p>
                  ...
                  <div className="md:flex-1">
                    <div className="p-6 sm:p-8 sm:pt-6 text-white">
                      ...
                      <p className="text-sm sm:text-base mb-2">
                        ...
                        side hustle, we are perfectly placed to bring your
                        vision to life. All of our sites include the following:
                      </p>
